...
- [Complete review, version, and lifecycle workflows](https://github.com/hey-nicolasklein/wardrobe/issues/7) — Explicit Keep, Reject, Regenerate, transient recovery, immutable cost/provenance history, version restore, Wanting/Owning/Archive transitions, and typed permanent deletion now complete the client-side persistent wardrobe loop.
