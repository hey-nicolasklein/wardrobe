...
- [Build the durable service foundation](https://github.com/hey-nicolasklein/wardrobe/issues/12) — PostgreSQL migrations, private account-scoped S3 media, leased remote-image jobs, dependency health, and deterministic cross-account fixtures now form one shared API/worker boundary.
