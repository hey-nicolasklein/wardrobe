...
function openCharacterDetail(id, returnTo = null) {
  ...
  if ($('#new-character-collage')) $('#new-character-collage').onclick = openCharacterSetup;
  if ($('#remove-character'))
