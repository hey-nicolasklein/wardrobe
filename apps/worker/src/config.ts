...
export const workerConfigSchema = z.object({
  ...
  OPENAI_DETECTION_PRICING_EFFECTIVE_DATE: z.iso.date().default('2026-07-30'),
  OPENAI_DETECTION_INPUT_RATE_MICRODOLLARS_PER_MILLION: z.coerce.number().int().positive().default(200_000),
  OPENAI_DETECTION_CACHED_INPUT_RATE_MICRODOLLARS_PER_MILLION: z.coerce.number().int().positive().default(20_000),
  OPENAI_DETECTION_CACHE_WRITE_RATE_MICRODOLLARS_PER_MILLION: z.coerce.number().int().positive().default(250_000),
  OPENAI_DETECTION_OUTPUT_RATE_MICRODOLLARS_PER_MILLION: z.coerce.number().int().positive().default(1_200_000),
